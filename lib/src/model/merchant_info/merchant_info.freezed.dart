...
mixin _$MerchantInfo {
 ...
 String get bakongAccountId; String get merchantId; String get acquiringBank; KhqrCurrency get currency; double get amount; String get merchantName; String get merchantCity; String? get billNumber; String? get mobileNumber; String? get storeLabel; String? get terminalLabel; String? get purposeOfTransaction; String? get upiAccountInformation; String? get merchantAlternateLanguagePreference; String? get merchantNameAlternateLanguage; String? get merchantCityAlternateLanguage; int? get expirationTimestamp;
...
@useResult
$Res call({
 String bakongAccountId, String merchantId, String acquiringBank, KhqrCurrency currency, double amount, String merchantName, String merchantCity, String? billNumber, String? mobileNumber, String? storeLabel, String? terminalLabel, String? purposeOfTransaction, String? upiAccountInformation, String? merchantAlternateLanguagePreference, String? merchantNameAlternateLanguage, String? merchantCityAlternateLanguage, int? expirationTimestamp
});
...
class _MerchantInfo implements MerchantInfo {
   _MerchantInfo({required this.bakongAccountId, required this.merchantId, required this.acquiringBank, this.currency = KhqrCurrency.khr, this.amount = 0, required this.merchantName, this.merchantCity = 'Phnom Penh', this.billNumber, this.mobileNumber, this.storeLabel, this.terminalLabel, this.purposeOfTransaction, this.upiAccountInformation, this.merchantAlternateLanguagePreference, this.merchantNameAlternateLanguage, this.merchantCityAlternateLanguage, this.expirationTimestamp});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MerchantInfo&&(identical(other.bakongAccountId, bakongAccountId) || other.bakongAccountId == bakongAccountId)&&(identical(other.merchantId, merchantId) || other.merchantId == merchantId)&&(identical(other.acquiringBank, acquiringBank) || other.acquiringBank == acquiringBank)&&(identical(other.currency, currency) || other.currency == currency)&&(identical(other.amount, amount) || other.amount == amount)&&(identical(other.merchantName, merchantName) || other.merchantName == merchantName)&&(identical(other.merchantCity, merchantCity) || other.merchantCity == merchantCity)&&(identical(other.billNumber, billNumber) || other.billNumber == billNumber)&&(identical(other.mobileNumber, mobileNumber) || other.mobileNumber == mobileNumber)&&(identical(other.storeLabel, storeLabel) || other.storeLabel == storeLabel)&&(identical(other.terminalLabel, terminalLabel) || other.terminalLabel == terminalLabel)&&(identical(other.purposeOfTransaction, purposeOfTransaction) || other.purposeOfTransaction == purposeOfTransaction)&&(identical(other.upiAccountInformation, upiAccountInformation) || other.upiAccountInformation == upiAccountInformation)&&(identical(other.merchantAlternateLanguagePreference, merchantAlternateLanguagePreference) || other.merchantAlternateLanguagePreference == merchantAlternateLanguagePreference)&&(identical(other.merchantNameAlternateLanguage, merchantNameAlternateLanguage) || other.merchantNameAlternateLanguage == merchantNameAlternateLanguage)&&(identical(other.merchantCityAlternateLanguage, merchantCityAlternateLanguage) || other.merchantCityAlternateLanguage == merchantCityAlternateLanguage)&&(identical(other.expirationTimestamp, expirationTimestamp) || other.expirationTimestamp == expirationTimestamp));
}
