...
class _MerchantInfo implements MerchantInfo {
   _MerchantInfo({required this.bakongAccountId, required this.merchantId, required this.acquiringBank, this.currency = KhqrCurrency.khr, required this.amount, required this.merchantName, this.merchantCity = 'Phnom Penh', this.billNumber, this.mobileNumber, this.storeLabel, this.terminalLabel, this.purposeOfTransaction, this.upiAccountInformation, this.merchantAlternateLanguagePreference, this.merchantNameAlternateLanguage, this.merchantCityAlternateLanguage, this.merchantCategoryCode = '5999', this.expirationTimestamp});
